...
function SellCard() {
  ...
  const calledNumbers = getStoredCalledNumbers();
  // const { calledNumbers } = useCalledNumbers();
                  ...
                  <div key={index} className="flex flex-row items-center justify-between gap-8 bg-gray-200 px-8 py-2">
                    ...
                    <div className="flex flex-row gap-4">
                      <Link
                        ...
                        className="rounded-full bg-purple-500 px-4 py-1 text-white hover:bg-purple-400"
                      >
                        view
                      </Link>
                      ...
                      <button
                        onClick={() => {
                          setCheckCardId(play.cardId);
                        }}
                        className="rounded-full bg-green-500 px-4 py-1 text-white hover:bg-green-400"
                      >
                        check card
                      </button>
                    </div>
