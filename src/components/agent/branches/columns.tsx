...
export default function getBranchColumns(handleEditBranch: (branchId: string) => void): ColumnDef<IBranch>[] {
  const columns: ColumnDef<IBranch>[] = [
    ...
    {
      id: "actions",
      cell: ({ row }) => <DataTableRowActions row={row} handleEditBranch={handleEditBranch} />,
    },
  ];
