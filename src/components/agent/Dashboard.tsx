...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    // today
    API.get(`/plays/agent-profit/${agentId}/today`)
      .then((result) => {
    ...
    // this month
    API.get(`/plays/agent-profit/${agentId}/this-month`)
      .then((result) => {
    ...
    // this year
    API.get(`/plays/agent-profit/${agentId}/this-year`)
      .then((result) => {
    ...
    // total
    API.get(`/plays/agent-profit/${agentId}/total`)
      .then((result) => {
    ...
    // twelve-month-report
    API.get(`/plays/agent-profit/${agentId}/twelve-month-report`)
      .then((result) => {
